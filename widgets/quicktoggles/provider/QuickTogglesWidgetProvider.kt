package com.nothingwingets.widgets.quicktoggles.provider
...
class QuickTogglesWidgetProvider : AppWidgetProvider() {
    override fun onUpdate(
        ...
        appWidgetIds.forEach { widgetId ->
            ...
            val views = RemoteViews(context.packageName, R.layout.widget_placeholder).apply {
                setTextViewText(R.id.widget_title, context.getString(R.string.quicktoggles_widget_title))
